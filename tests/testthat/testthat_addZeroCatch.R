...
test_that("addZeroCatch() test output types",{
  ...
  expect_equal(class(df1mod),"data.frame")
  ...
  expect_equal(class(df2mod),"data.frame")
  ...
  df3mod <- suppressWarnings(addZeroCatch(df3,eventvar="net",specvar="species",
                                          zerovar="catch"))
  expect_equal(class(df3mod),"data.frame")
  ...
  expect_equal(class(df4mod),"data.frame")
  ...
  df5mod <- addZeroCatch(df5,eventvar="net",specvar=c("species","sex"),
                         zerovar="catch")
  expect_equal(class(df5mod),"data.frame")
